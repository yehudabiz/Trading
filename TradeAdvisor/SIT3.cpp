...
TraderSit3::TraderSit3 (int symbol, int period, double sl, double tp)
{
	m_max_size = 200;
	m_stoch_k = 100;
	m_stoch_d = 5;
...
void TraderSit3::AskAdvise(int& advise, double& stop_loss, double& take_profit)
{
	advise = 0;
	stop_loss = 0;
	take_profit = 0;
...
void TraderSit3::UpdatePrice(Bar bar)
{
